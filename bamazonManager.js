...
var addNewProduct = function(){
	...
	prompt.get(newProduct, function(err, res){
		...
		connection.query('INSERT INTO Products (item_iD, product_name, department_name, price,stock_quantity) VALUES (?, ?, ?, ?, ?)', 
		 						addedProduct[0].newIdNum, 
		 						addedProduct[0].newItemName, 
		 						addedProduct[0].newItemDepartment, 
		 						addedProduct[0].newItemPrice, 
		 						addedProduct[0].newStockQuantity, function(err, result){
